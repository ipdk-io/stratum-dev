...
class TdiFixedFunctionManager {
 public:
  ...
  ::util::Status FetchVportTableData(
      ...
      uint64* data) ABSL_LOCKS_EXCLUDED(lock_);
 ...
 private:
  ...
  ::util::Status BuildSadbTableKey(
      ...
      IPsecSADBConfig& sadb_config) ABSL_SHARED_LOCKS_REQUIRED(lock_);
