...
// Class 'Es2kHal' is nothing but a wrapper around all the HAL services, which
...
class Es2kHal final {
 public:
  ...
  Es2kHal& operator=(const Es2kHal&) = delete;

  // Pipe file descriptors used to deliver signals from the handler to Es2kHal.
