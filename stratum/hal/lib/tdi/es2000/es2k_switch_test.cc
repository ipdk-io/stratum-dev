...
#if 0
// No GetPortState()
TEST_F(Es2kSwitchTest, GetPortOperStatus) {
  PushChassisConfigSuccessfully();
...
TEST_F(Es2kSwitchTest, GetPortAdminStatus) {
  PushChassisConfigSuccessfully();
...
TEST_F(Es2kSwitchTest, GetMacAddressPass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
...
#if 0
// No BcmPort
TEST_F(Es2kSwitchTest, GetPortSpeed) {
  PushChassisConfigSuccessfully();
...
TEST_F(Es2kSwitchTest, GetMemoryErrorAlarmStatePass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
#if 0
  // Expect Write() call and store data in resp.
...
TEST_F(Es2kSwitchTest, GetFlowProgrammingExceptionAlarmStatePass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
  // Expect Write() call and store data in resp.
  ExpectMockWriteDataResponse(&writer, &resp);
...
// Doesn't work
TEST_F(Es2kSwitchTest, GetHealthIndicatorPass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
  // Expect Write() call and store data in resp.
  ExpectMockWriteDataResponse(&writer, &resp);
...
// Doesn't work
TEST_F(Es2kSwitchTest, GetForwardingViablePass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
  // Expect Write() call and store data in resp.
  ExpectMockWriteDataResponse(&writer, &resp);
...
=
TEST_F(Es2kSwitchTest, GetQosQueueCountersPass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
  // Expect Write() call and store data in resp.
  ExpectMockWriteDataResponse(&writer, &resp);
...
TEST_F(Es2kSwitchTest, GetNodePacketIoDebugInfoPass) {
  WriterMock<DataResponse> writer;
  DataResponse resp;
  // Expect Write() call and store data in resp.
  ExpectMockWriteDataResponse(&writer, &resp);
...
TEST_F(Es2kSwitchTest, GetPortLoopbackStatus) {
  PushChassisConfigSuccessfully();
...
TEST_F(Es2kSwitchTest, SetPortLoopbackStatusPass) {
  EXPECT_CALL(*chassis_manager_mock_,
