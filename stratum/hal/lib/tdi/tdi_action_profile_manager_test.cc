...
protected:
    void SetUp() override {
        ...
        tdi_action_profile_manager_ = TdiActionProfileManager::CreateInstance(
...
/*
* This test validates WriteActionProfileEntry for update type: INSERT
...
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionProfileIdInsert) {
    // create extern entry
    ...
    EXPECT_OK(tdi_action_profile_manager_->WriteActionProfileEntry(session_mock, update_type,
              entry));
}

/*
* This test validates WriteActionProfileEntry for update type: MODIFY
* Extern entry is wrapped with action profile member and the function
* is expected to return OK after invoking it with correct set of params. 
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionProfileIdModify) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    entry.set_extern_id(kTnaExternActionProfileId);
    entry.set_extern_type_id(kTnaExternActionProfileId);
...
/*
* This test validates WriteActionProfileEntry for update type: DELETE
* Extern entry is wrapped with action profile member and the function
* is expected to return OK after invoking it with correct set of params. 
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionProfileIdDelete) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    entry.set_extern_id(kTnaExternActionProfileId);
    entry.set_extern_type_id(kTnaExternActionProfileId);
...
* is expected to return OK after invoking it with correct set of params. 
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionSelectorIdInsert) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
...
* is expected to return OK after invoking it with correct set of params. 
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionSelectorIdModify) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    entry.set_extern_id(kTnaExternActionSelectorId);
    entry.set_extern_type_id(kTnaExternActionSelectorId);
...
* is expected to return OK after invoking it with correct set of params. 
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestActionSelectorIdDelete) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    entry.set_extern_id(kTnaExternActionSelectorId);
    entry.set_extern_type_id(kTnaExternActionSelectorId);
...
*/
TEST_F(TdiActionProfileManagerTest, WriteActionProfileEntryTestUnsupportedType) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    ...
    // perform test and check results (act + assert)
    EXPECT_THAT(tdi_action_profile_manager_->WriteActionProfileEntry(session_mock, update_type,
                entry), DerivedFromStatus(InvalidParamError()));
}

/*
* This test validates ReadActionProfileEntry
...
TEST_F(TdiActionProfileManagerTest, ReadActionProfileEntryTestActionProfileId) {
    ...
    // perform test and check results (act + assert)
    EXPECT_OK(tdi_action_profile_manager_->ReadActionProfileEntry(session_mock, entry, &writer_mock));
}
...
* We match the read operation output with the expected response.
*/
TEST_F(TdiActionProfileManagerTest, ReadActionProfileEntryTestActionSelectorId) {
    // create extern entry
    ::p4::v1::ExternEntry entry;
    entry.set_extern_id(kTnaExternActionSelectorId);
    entry.set_extern_type_id(kTnaExternActionSelectorId);
    ...
    EXPECT_CALL(
        ...
        *sde_wrapper_mock_,
        ...
        // action to take on first and only call
        .WillOnce(DoAll(SetArgPointee<4>(group_ids), SetArgPointee<5>(max_group_sizes),
...
/*
* This test validates ReadActionProfileEntry for update type: INSERT
* Extern entry is wrapped with unsupported extern type id and the function
* is supposed to return error with Unsupported extern type id. 
*/
TEST_F(TdiActionProfileManagerTest, ReadActionProfileEntryTestUnsupportedType) {
    ...
    // perform test and check results (act + assert)
    EXPECT_THAT(tdi_action_profile_manager_->ReadActionProfileEntry(session_mock, entry,
                writer), DerivedFromStatus(OperNotSuppError()));
}
