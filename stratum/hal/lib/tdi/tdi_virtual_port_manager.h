...
#ifndef STRATUM_HAL_LIB_TDI_TDI_VIRTUAL_PORT_MANAGER_H_
#define STRATUM_HAL_LIB_TDI_TDI_VIRTUAL_PORT_MANAGER_H_
...
// TdiVirtualPortManager is a proxy class for per target virtual port management
class TdiVirtualPortManager {
 public:
  ...
  TdiVirtualPortManager();
  virtual ~TdiVirtualPortManager() {}
...
#endif  // STRATUM_HAL_LIB_TDI_TDI_VIRTUAL_PORT_MANAGER_H_
