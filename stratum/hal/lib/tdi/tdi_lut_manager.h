...
#ifndef STRATUM_HAL_LIB_TDI_TDI_LUT_MANAGER_H_
#define STRATUM_HAL_LIB_TDI_TDI_LUT_MANAGER_H_
...
class TdiLutManager {
 public:
  ...
  ::util::Status WriteTableEntry(
      ...
      const ::p4::v1::ExternEntry& entry) LOCKS_EXCLUDED(lock_);
  ...
  static std::unique_ptr<TdiLutManager> CreateInstance(
...
#endif  // STRATUM_HAL_LIB_TDI_TDI_LUT_MANAGER_H_
