...
#ifndef STRATUM_HAL_LIB_TDI_TDI_ES2K_STRUCTS_H_
#define STRATUM_HAL_LIB_TDI_TDI_ES2K_STRUCTS_H_
...
struct PktModMeterConfig {
  ...
  bool in_pps;          /* In Packet Per Second - Flag to check
                           direct or indirect PacketModMeter */
};
...
#endif  // STRATUM_HAL_LIB_TDI_TDI_ES2K_STRUCTS_H_
