...
class BfrtP4RuntimeTranslator {
 public:
  ...
  virtual ::util::StatusOr<::p4::v1::CounterEntry> TranslateCounterEntry(
      const ::p4::v1::CounterEntry& entry, bool to_sdk) ABSL_LOCKS_EXCLUDED(lock_);
  ...
  virtual ::util::StatusOr<::p4::v1::RegisterEntry> TranslateRegisterEntry(
      const ::p4::v1::RegisterEntry& entry, bool to_sdk) ABSL_LOCKS_EXCLUDED(lock_);
  ...
  virtual ::util::StatusOr<::p4::v1::PacketIn> TranslatePacketIn(
      const ::p4::v1::PacketIn& packet_in) ABSL_LOCKS_EXCLUDED(lock_);
  virtual ::util::StatusOr<::p4::v1::PacketOut> TranslatePacketOut(
      const ::p4::v1::PacketOut& packet_out) ABSL_LOCKS_EXCLUDED(lock_);
 ...
 private:
  ...
  virtual ::util::StatusOr<::p4::v1::PacketMetadata> TranslatePacketMetadata(
      ...
      int32 bit_width, bool to_sdk) ABSL_SHARED_LOCKS_REQUIRED(lock_);
  ...
  virtual ::util::StatusOr<::p4::v1::Action> TranslateAction(
      const ::p4::v1::Action& action, bool to_sdk) ABSL_SHARED_LOCKS_REQUIRED(lock_);
  ...
  bool pipeline_require_translation_ ABSL_GUARDED_BY(lock_);
  ...
  absl::flat_hash_map<uint32, absl::flat_hash_map<uint32, std::string>>
      table_to_field_to_type_uri_ ABSL_GUARDED_BY(lock_);
  absl::flat_hash_map<uint32, absl::flat_hash_map<uint32, std::string>>
      action_to_param_to_type_uri_ ABSL_GUARDED_BY(lock_);
  ...
  absl::flat_hash_map<uint32, std::string> counter_to_type_uri_
      ABSL_GUARDED_BY(lock_);
  absl::flat_hash_map<uint32, std::string> meter_to_type_uri_ ABSL_GUARDED_BY(lock_);
  absl::flat_hash_map<uint32, std::string> register_to_type_uri_
      ABSL_GUARDED_BY(lock_);
  absl::flat_hash_map<uint32, absl::flat_hash_map<uint32, int32>>
      table_to_field_to_bit_width_ ABSL_GUARDED_BY(lock_);
  absl::flat_hash_map<uint32, absl::flat_hash_map<uint32, int32>>
      action_to_param_to_bit_width_ ABSL_GUARDED_BY(lock_);
